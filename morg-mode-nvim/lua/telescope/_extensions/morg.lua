                ...
                entry_maker = function(item)
                    return {
                        ...
                        display = function(entry)
                            return displayer({
                                { entry.value.status, entry.value.status == "DONE" and "TelescopeResultsComment" or "WarningMsg" },
                                { entry.value.priority or "", "DiagnosticError" },
                                { entry.value.effort or "", "Comment" },
                                entry.value.text .. (entry.value.heading and (" (" .. entry.value.heading .. ")") or ""),
                            })
                        end,
                ...
                entry_maker = function(item)
                    return {
                        ...
                        display = function(entry)
                            ...
                            if entry.value.kind == "DEADLINE" then kind_hl = "DiagnosticError"
                            elseif entry.value.kind == "SCHEDULED" then kind_hl = "DiagnosticInfo"
                            elseif entry.value.kind == "EVENT" then kind_hl = "DiagnosticHint" end
